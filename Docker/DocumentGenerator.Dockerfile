...
COPY Sahadeva.Dossier.DocumentGenerator/*.csproj Sahadeva.Dossier.DocumentGenerator/
...
RUN dotnet restore ./Sahadeva.Dossier.DocumentGenerator/Sahadeva.Dossier.DocumentGenerator.csproj

# Copy the remaining project files
COPY . ./

# Build and publish a release
RUN dotnet publish Sahadeva.Dossier.DocumentGenerator/Sahadeva.Dossier.DocumentGenerator.csproj -c Release -o out
...
ENTRYPOINT ["dotnet", "Sahadeva.Dossier.DocumentGenerator.dll"]
